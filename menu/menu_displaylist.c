...
#endif
#ifdef HAVE_NIRCADA
      if (flags & SD_FLAG_NIRCADA_ADVANCED)
         goto end;
#endif
   }
...
#ifdef HAVE_NIRCADA
      if (settings->bools.menu_show_timezone && !settings->bools.kiosk_mode_enable)
      {
         if (menu_entries_append_enum(list,
               msg_hash_to_str(MENU_ENUM_LABEL_VALUE_TIMEZONE_SETTINGS),
               msg_hash_to_str(MENU_ENUM_LABEL_TIMEZONE_SETTINGS),
      ...
      bool include_everything)
{
   ...
   switch (type)
   {
      ...
      case DISPLAYLIST_LATENCY_SETTINGS_LIST:
         ...
         break;
#ifdef HAVE_NIRCADA
      case DISPLAYLIST_TIMEZONE_SETTINGS_LIST:
         {
            menu_displaylist_build_info_t build_list[] = {
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_ABIDJAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_ACCRA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_ALGIERS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_BISSAU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_CAIRO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_CASABLANCA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_CEUTA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_EL_AAIUN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_JOHANNESBURG, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_JUBA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_KHARTOUM, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_LAGOS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_MAPUTO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_MONROVIA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_NAIROBI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_NDJAMENA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_SAO_TOME, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_TRIPOLI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_TUNIS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AFRICA_WINDHOEK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ADAK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ANCHORAGE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARAGUAINA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_BUENOS_AIRES, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_CATAMARCA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_CORDOBA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_JUJUY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_LA_RIOJA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_MENDOZA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_RIO_GALLEGOS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_SALTA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_SAN_JUAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_SAN_LUIS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_TUCUMAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ARGENTINA_USHUAIA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ASUNCION, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ATIKOKAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_BAHIA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_BAHIA_BANDERAS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_BARBADOS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_BELEM, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_BELIZE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_BLANC_SABLON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_BOA_VISTA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_BOGOTA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_BOISE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_CAMBRIDGE_BAY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_CAMPO_GRANDE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_CANCUN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_CARACAS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_CAYENNE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_CHICAGO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_CHIHUAHUA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_COSTA_RICA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_CRESTON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_CUIABA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_CURACAO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_DANMARKSHAVN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_DAWSON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_DAWSON_CREEK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_DENVER, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_DETROIT, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_EDMONTON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_EIRUNEPE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_EL_SALVADOR, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_FORT_NELSON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_FORTALEZA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_GLACE_BAY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_GOOSE_BAY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_GRAND_TURK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_GUATEMALA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_GUAYAQUIL, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_GUYANA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_HALIFAX, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_HAVANA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_HERMOSILLO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_INDIANA_INDIANAPOLIS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_INDIANA_KNOX, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_INDIANA_MARENGO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_INDIANA_PETERSBURG, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_INDIANA_TELL_CITY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_INDIANA_VEVAY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_INDIANA_VINCENNES, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_INDIANA_WINAMAC, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_INUVIK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_IQALUIT, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_JAMAICA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_JUNEAU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_KENTUCKY_LOUISVILLE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_KENTUCKY_MONTICELLO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_LA_PAZ, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_LIMA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_LOS_ANGELES, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MACEIO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MANAGUA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MANAUS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MARTINIQUE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MATAMOROS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MAZATLAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MENOMINEE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MERIDA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_METLAKATLA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MEXICO_CITY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MIQUELON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MONCTON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MONTERREY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_MONTEVIDEO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_NASSAU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_NEW_YORK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_NIPIGON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_NOME, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_NORONHA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_NORTH_DAKOTA_BEULAH, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_NORTH_DAKOTA_CENTER, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_NORTH_DAKOTA_NEW_SALEM, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_NUUK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_OJINAGA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_PANAMA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_PANGNIRTUNG, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_PARAMARIBO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_PHOENIX, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_PORT_AU_PRINCE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_PORT_OF_SPAIN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_PORTO_VELHO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_PUERTO_RICO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_PUNTA_ARENAS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_RAINY_RIVER, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_RANKIN_INLET, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_RECIFE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_REGINA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_RESOLUTE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_RIO_BRANCO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_SANTAREM, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_SANTIAGO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_SANTO_DOMINGO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_SAO_PAULO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_SCORESBYSUND, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_SITKA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_ST_JOHNS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_SWIFT_CURRENT, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_TEGUCIGALPA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_THULE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_THUNDER_BAY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_TIJUANA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_TORONTO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_VANCOUVER, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_WHITEHORSE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_WINNIPEG, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_YAKUTAT, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AMERICA_YELLOWKNIFE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ANTARCTICA_CASEY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ANTARCTICA_DAVIS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ANTARCTICA_DUMONTDURVILLE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ANTARCTICA_MACQUARIE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ANTARCTICA_MAWSON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ANTARCTICA_PALMER, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ANTARCTICA_ROTHERA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ANTARCTICA_SYOWA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ANTARCTICA_TROLL, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ANTARCTICA_VOSTOK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_ALMATY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_AMMAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_ANADYR, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_AQTAU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_AQTOBE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_ASHGABAT, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_ATYRAU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_BAGHDAD, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_BAKU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_BANGKOK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_BARNAUL, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_BEIRUT, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_BISHKEK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_BRUNEI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_CHITA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_CHOIBALSAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_COLOMBO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_DAMASCUS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_DHAKA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_DILI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_DUBAI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_DUSHANBE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_FAMAGUSTA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_GAZA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_HEBRON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_HO_CHI_MINH, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_HONG_KONG, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_HOVD, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_IRKUTSK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_JAKARTA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_JAYAPURA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_JERUSALEM, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_KABUL, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_KAMCHATKA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_KARACHI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_KATHMANDU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_KHANDYGA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_KOLKATA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_KRASNOYARSK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_KUALA_LUMPUR, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_KUCHING, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_MACAU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_MAGADAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_MAKASSAR, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_MANILA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_NICOSIA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_NOVOKUZNETSK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_NOVOSIBIRSK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_OMSK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_ORAL, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_PONTIANAK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_PYONGYANG, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_QATAR, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_QOSTANAY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_QYZYLORDA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_RIYADH, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_SAKHALIN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_SAMARKAND, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_SEOUL, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_SHANGHAI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_SINGAPORE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_SREDNEKOLYMSK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_TAIPEI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_TASHKENT, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_TBILISI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_TEHRAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_THIMPHU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_TOKYO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_TOMSK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_ULAANBAATAR, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_URUMQI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_UST_NERA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_VLADIVOSTOK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_YAKUTSK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_YANGON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_YEKATERINBURG, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ASIA_YEREVAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ATLANTIC_AZORES, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ATLANTIC_BERMUDA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ATLANTIC_CANARY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ATLANTIC_CAPE_VERDE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ATLANTIC_FAROE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ATLANTIC_MADEIRA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ATLANTIC_REYKJAVIK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ATLANTIC_SOUTH_GEORGIA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_ATLANTIC_STANLEY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_ADELAIDE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_BRISBANE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_BROKEN_HILL, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_CURRIE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_DARWIN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_EUCLA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_HOBART, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_LINDEMAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_LORD_HOWE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_MELBOURNE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_PERTH, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_AUSTRALIA_SYDNEY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_AMSTERDAM, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_ANDORRA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_ASTRAKHAN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_ATHENS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_BELGRADE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_BERLIN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_BRUSSELS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_BUCHAREST, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_BUDAPEST, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_CHISINAU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_COPENHAGEN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_DUBLIN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_GIBRALTAR, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_HELSINKI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_ISTANBUL, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_KALININGRAD, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_KIEV, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_KIROV, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_LISBON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_LONDON, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_LUXEMBOURG, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_MADRID, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_MALTA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_MINSK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_MONACO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_MOSCOW, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_OSLO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_PARIS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_PRAGUE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_RIGA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_ROME, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_SAMARA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_SARATOV, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_SIMFEROPOL, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_SOFIA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_STOCKHOLM, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_TALLINN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_TIRANE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_ULYANOVSK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_UZHGOROD, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_VIENNA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_VILNIUS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_VOLGOGRAD, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_WARSAW, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_ZAPOROZHYE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_EUROPE_ZURICH, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_INDIAN_CHAGOS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_INDIAN_CHRISTMAS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_INDIAN_COCOS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_INDIAN_KERGUELEN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_INDIAN_MAHE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_INDIAN_MALDIVES, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_INDIAN_MAURITIUS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_INDIAN_REUNION, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_APIA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_AUCKLAND, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_BOUGAINVILLE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_CHATHAM, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_CHUUK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_EASTER, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_EFATE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_ENDERBURY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_FAKAOFO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_FIJI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_FUNAFUTI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_GALAPAGOS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_GAMBIER, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_GUADALCANAL, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_GUAM, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_HONOLULU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_KIRITIMATI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_KOSRAE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_KWAJALEIN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_MAJURO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_MARQUESAS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_NAURU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_NIUE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_NORFOLK, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_NOUMEA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_PAGO_PAGO, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_PALAU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_PITCAIRN, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_POHNPEI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_PORT_MORESBY, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_RAROTONGA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_TAHITI, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_TARAWA, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_TONGATAPU, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_WAKE, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_PACIFIC_WALLIS, PARSE_ONLY_STRING},
               {MENU_ENUM_LABEL_TIMEZONE_UTC, PARSE_ONLY_STRING},
            };

            settings_t      *settings     = config_get_ptr();
            char timezone = settings->arrays.timezone;
...
#ifdef HAVE_NIRCADA
               {MENU_ENUM_LABEL_TIMEZONE_SETTINGS, PARSE_ACTION, true},
#endif
...
#ifdef HAVE_NIRCADA
                     build_list[i].checked = settings->bools.settings_show_timezone;
#else
                     build_list[i].checked = false;
#endif
                     break;
...
#ifdef HAVE_NIRCADA
               {MENU_ENUM_LABEL_SETTINGS_SHOW_TIMEZONE,         PARSE_ONLY_BOOL},
#endif
...
#ifdef HAVE_NIRCADA
               {MENU_ENUM_LABEL_CONTENT_SHOW_TIMEZONE,                  PARSE_ONLY_BOOL},
#endif
